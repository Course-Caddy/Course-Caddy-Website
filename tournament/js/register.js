...
function gatherFormData() {
    ...
    // Humidity is optional - default to 50 if field doesn't exist
    const humidityField = document.getElementById('baseline-humidity');
    const baselineHumidity = humidityField ? (parseInt(humidityField.value) || 50) : 50;
